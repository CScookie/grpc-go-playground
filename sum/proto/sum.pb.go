...
type SumRequest struct {
	...
	FirstInt  uint32 `protobuf:"varint,1,opt,name=first_int,json=firstInt,proto3" json:"first_int,omitempty"`
	SecondInt uint32 `protobuf:"varint,2,opt,name=second_int,json=secondInt,proto3" json:"second_int,omitempty"`
}
...
func (x *SumRequest) GetFirstInt() uint32 {
	if x != nil {
		return x.FirstInt
	}
	return 0
...
func (x *SumRequest) GetSecondInt() uint32 {
	if x != nil {
		return x.SecondInt
	}
	return 0
...
var file_sum_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x08, 0x66, 0x69, 0x72, 0x73, 0x74, 0x49, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73,
	0x65, 0x63, 0x6f, 0x6e, 0x64, 0x5f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x73, 0x63, 0x6f, 0x6f, 0x6b, 0x69, 0x65,
